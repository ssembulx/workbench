...
export class FeedbackComponent implements OnInit {
  ...
  constructor(private service: SummaryService,private modalService:NgbModal,config: NgbModalConfig,)   
  {
  ...
  EditRow(editmodal:any,id:any){
   ...
   UpdateTable(){
    debugger
    let req:any = {"id":this.modal.id,"status":this.modal.Status,"comments":this.modal.Comments}
